...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    try{
        ...
        require_once("admin_login_contr.inc.php");
        require_once("admin_login_model.inc.php");
        $errors = [];
        ...
        $session_id = $new_session_id . "_" . "admin-" . $result["user_id"];
        session_id($session_id);
        
        $_SESSION["user_id"] = "admin-" . $result["user_id"] ;
        $_SESSION["username"] = "admin-" . htmlspecialchars($result["username"] );
